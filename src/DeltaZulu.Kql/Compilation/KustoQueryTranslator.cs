...
internal sealed class KustoQueryTranslator
{
    ...
    public KustoQueryTranslator(IKqlSchemaCatalog catalog, KqlDiagnosticBuilder diagnostics)
    {
        _catalog = catalog;
    ...
    public RelNode? Translate(string kql)
    {
        ...
        {
            _diagnostics.AddError(KqlDiagnosticPhase.Parse, "No statement found in KQL input.");
            return null;
        }
    ...
    private RelNode? TranslateLetChain(IReadOnlyList<Statement> statements)
    {
        ...
        {
            _diagnostics.AddError(KqlDiagnosticPhase.Translate,
    ...
    private RelNode? TranslatePrint(PrintOperator print)
    {
        ...
        {
            _diagnostics.AddError(KqlDiagnosticPhase.Translate, "print requires at least one expression.");
            return null;
        }
    ...
    private RelNode? TranslateTableRef(NameReference name)
    {
        ...
        {
            _diagnostics.AddError(KqlDiagnosticPhase.Policy,
                $"Table '{tableName}' is not an approved table.");
            return null;
        }
    ...
    private RelNode? TranslateTableRefExpression(PathExpression path)
    {
        ...
        if (!_catalog.TryGetTable(tableName, out _))
        {
            ...
            _diagnostics.AddError(KqlDiagnosticPhase.Policy,
                $"Table '{sanitizedTableName}' is not an approved table.");
            return null;
        }
    ...
    {
        _diagnostics.AddError(KqlDiagnosticPhase.Translate, reason,
